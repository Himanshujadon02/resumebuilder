...
class ResumeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels={'name':'Full Name','dob':'Date of Birth','pin':'Pin code','mobile':'Mobile Number','email':'Email Id','job_city':'Preferred Job Location','profile_image':'Profile Image','my_file':'Document'}
        widgets = {
